 ...
 */
@Command(name = "test-command", scope = "CMC", description = "add a description for the command")
public class AaaCertManagerConsumerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(AaaCertManagerConsumerCliTestCommand.class);
    protected final AaaCertManagerConsumerCliCommands service;

    public AaaCertManagerConsumerCliTestCommand(final AaaCertManagerConsumerCliCommands service) {
